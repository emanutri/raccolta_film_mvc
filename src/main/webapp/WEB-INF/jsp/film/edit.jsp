	...
	<main role="main" class="container">
		...
		<div class='card'>
		    ...
		    <div class='card-body'>
					...
					<form:form method="post" modelAttribute="film_attribute" action="update" novalidate="novalidate" >
					
						<div class="form-row">
							<div class="form-group col-md-6">
								<label for="titolo">Titolo</label>
								<spring:bind path="titolo">
									<input type="text" name="titolo" id="titolo" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire il titolo" value="${film_attribute.titolo }">
								</spring:bind>
							...
							<div class="form-group col-md-6">
								...
								<spring:bind path="genere">
									<input type="text" name="genere" id="genere" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire il genere" value="${film_attribute.genere }">
								</spring:bind>
						...
						<div class="form-row">	
							...
							<div class="form-group col-md-6">
								...
								<spring:bind path="minutiDurata">
									<input type="number" class="form-control ${status.error ? 'is-invalid' : ''}" name="minutiDurata" id="minutiDurata" placeholder="Inserire la durata" value="${film_attribute.minutiDurata }">
								</spring:bind>
